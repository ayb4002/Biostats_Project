...
1. Drug combination group (DOX + EVO) gives more tumor response than mono (DOX) treatment.
2. No significant factors associated with percent change in tumor diameters using linear regression. 
3. If the patient is male, or belongs to white race, or younger or equal to 60, they would experience more tumor response if they are receiving treatment DOX + EVO. But this effect is not significant in females, other races, and patients who are older than 60. 


## Limitations

1. We observed a significantly higher proportion of white ethnicity participants in the study. This can lead to biased outcomes. 
2. The patients’ stages at diagnosis are not equally allocated in the two arms. There are more patients in stage III at diagnosis. This may also lead to biased outcomes.
